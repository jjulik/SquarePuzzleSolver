...
check(piecesShifted_p[3]->sides[(2+c[3])&3], piecesShifted_p[6]->sides[c[6]]) &&
...
check(piecesShifted_p[0]->sides[(1+c[0])&3], piecesShifted_p[1]->sides[(3+c[1])&3]) &&
check(piecesShifted_p[1]->sides[(1+c[1])&3], piecesShifted_p[2]->sides[(3+c[2])&3]) &&
check(piecesShifted_p[3]->sides[(1+c[3])&3], piecesShifted_p[4]->sides[(3+c[4])&3]) &&
